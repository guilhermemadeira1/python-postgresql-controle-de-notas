from sistema_notas.banco import Banco
from sistema_notas.aluno import Aluno
...
while True:
    ...
    match escolha:
        case 1:
            ...
            if(banco.registrar_aluno(matricula, nome, nota1, nota2)):
                print("Registro feito com sucesso!")
                print(f" > Matricula: {matricula}\n > Nome: {nome}\n > Nota 1: {nota1}\n > Nota 2: {nota2}")
        case 2:
            listagem = banco.buscar_todos_alunos()
            alunos = []
        ...
        case 3:
            ...
            if banco.atualizar_nota1(matricula,nota1) and banco.atualizar_nota2(matricula,nota2):
                print("Atualização realizada com sucesso!")
        case 4:
            print("[REMOÇÂO DE ALUNO]")
            matricula = int(input("Digite a matricula do aluno que será removido: "))
            if(banco.deletar_aluno(matricula)):
